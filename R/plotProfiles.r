classification.plot <- function(classifications,save.path) {
  ...
  lapply(
    ...
    ,function(classification) {
      ...
      plot(type="l",col="white",x=1:2,y=rep(0,2),ylim=c(0,1),ylab="Accuracy",xlab="",main=main,cex.main=0.9)
      ...
      legend("bottomleft",c("knn","qda","svm","chance"),lty=c(4,3,2,1),col=c("red","blue","green","black"),inset=0.05)
      ...
      # Plot box plot for svm and qda accuracies
      boxplot(classification$qda,main=paste(main,"using svm",sep=" "))
      boxplot(classification$svm,main=paste(main,"using qda",sep=" "))
    }
  )
  dev.off()
}
...
final.plot <- function(analyzed.males,analyzed.females,path) {
  ...
  comparison.plot(
    ...
    ,msummary$all$before
    ,fsummary$all$before
    ,path,"mabfab","all males before","all females before"
  )
  comparison.plot(
    taxis
    ,msummary$all$during
    ,fsummary$all$during
    ,path,"madfad","all males during","all females during"
  )
  comparison.plot(
    taxis
    ,msummary$pregnant$during
    ,fsummary$pregnant$during
    ,path,"mpdfpd","males pregnant during","females pregnant during"
  )
  comparison.plot(
    taxis
    ,msummary$pregnant$during
  ...
  comparison.plot(
    ...
    ,msummary$all$during
    ,fsummary$pregnant$during
    ,path,"madfpd","all males during","females pregnant during"
  )
  comparison.plot(
    taxis
    ,fsummary$pregnant$before
    ,fsummary$pregnant$during
    ,path,"fpbfpd","females pregnant before","females pregnant during"
  )
  comparison.plot(
    taxis
    ,msummary$pregnant$before
    ,msummary$pregnant$during
    ,path,"mpbmpd","males pregnant before","males pregnant during"
  )
  comparison.plot(
    taxis
    ,fsummary$test$during
    ,fsummary$pregnant$during
    ,path,"ftdfpd","females test during","females pregnant during"
  )
  comparison.plot(
    taxis
    ,msummary$test$during
    ,msummary$pregnant$during
    ,path,"mtdmpd","males test during","males pregnant during"
  )
  comparison.plot(
    taxis
    ,msummary$all$during
...
comparison.plot <- function(taxis,summary.1,summary.2,path,type,type.1,type.2) {
  ...
  plot(
    ...
    ,ylab="Probability of tweet"
    ,type="l"
    ,ylim=c(0,max(summary.2$acf$mean+summary.2$acf$sde,summary.1$acf$mean+summary.1$acf$sde))
    ,col="black"
